...
class CreateResearchsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('researchs', function (Blueprint $table) {
            ...
            $table->longText('research_period_start')->nullable()->default(null);
            $table->longText('research_period_end')->nullable()->default(null);
            ...
            $table->longText('research_main_group')->nullable()->default(null);
            $table->longText('research_main_branch')->nullable()->default(null);
