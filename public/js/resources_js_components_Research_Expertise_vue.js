        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              _this.selected = _this.expertise_exp_main_field.map(function (e) {
                return e.expMainFieldId;
              });
              _this.selectAll = ["all"];
                              ...
                              },
                              {
                                ...
                                fn: function (ref) {
                                  ...
                                  return [
                                    ...
                                    _vm._v(
                                      "\n              " +
                                        _vm._s("" + (item.expDetail || "")) +
                                        "\n              "
                                    ),
                                    _c("br"),
                                    _vm._v(" "),
                                    !_vm.isEmpty(item.isResearch)
                                      ? [
                                          _c("strong", [
                                            _vm._v(
                                    ...
                                    !_vm.isEmpty(item.isService)
                                      ...
                                      : _vm._e(),
                                    _vm._v(" "),
                                    !_vm.isEmpty(item.isAward)
                                      ? [
                                          _c("strong", [
                                            _vm._v(
                                              " ได้รับรางวัลในสาขาวิชาที่มีความเชี่ยวชาญ "
                                            ),
                                          ]),
                                          _vm._v(" "),
                                          _c("br"),
                                      ...
                                      : _vm._e(),
                                    _vm._v(" "),
                                    !_vm.isEmpty(item.isExperience)
                                      ? [
                                          _c("strong", [
                                            _vm._v(
                                              " ความเชี่ยวชาญที่สั่งสมจากประสบการณ์การทำงาน "
                                            ),
                                          ]),
                                          _vm._v(" "),
                                          _c("br"),
